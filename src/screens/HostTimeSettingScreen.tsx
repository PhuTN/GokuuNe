...
const HostTimeSettingScreen = ({ route, navigation }: Props) => {
    ...
    const [customMinutes, setCustomMinutes] = useState(() => {
        ...
        if (typeof selectedTime === "string" && selectedTime.includes(t.host_time_min)) {
    ...
    const quickTimes = [
        ...
        },
        {
            ...
            times: showCustomTime
                ? ['3 ' + t.host_time_min, '3 | 2', '5 ' + t.host_time_min, '5 | 5', '5 | 2', '5 | 3']
        ...
        },
        {
            ...
            Icon: RapidIcon,
            times: showCustomTime
                ? ['10 ' + t.host_time_min, '15 | 10', '30 ' + t.host_time_min, '10 | 5', '20 ' + t.host_time_min, '60 ' + t.host_time_min]
        ...
        },
        {
            ...
            Icon: DailyIcon,
            times: showCustomTime
                ? ['1 ' + t.host_time_day, '3 ' + t.host_time_days, '7 ' + t.host_time_days, '2 ' + t.host_time_days, '5 ' + t.host_time_days, '14 ' + t.host_time_days]
                : ['1 ' + t.host_time_day, '3 ' + t.host_time_days, '7 ' + t.host_time_days]
        }
    ];
                    ...
                    <View style={styles.buttonRow}>
                        {section.times.map((time, idx) => (
                            <TouchableOpacity
                                ...
                                style={[styles.touchableContainer, selectedTime === time && { borderColor: "#FFCF26", borderWidth: 5, borderRadius: 20 }]}
                            >
                                <LinearGradient
            ...
            {showCustomTime && (
                <View style={styles.section}>
                    ...
                    <View style={styles.customTimeSection}>
                        ...
                        <Text style={styles.sliderLabel}>{t.host_time_initial_time} {customMinutes} {t.host_time_min}</Text>
                        ...
                        <Text style={styles.sliderLabel}>{t.host_time_bonus_time} {customSeconds} {t.host_time_sec}</Text>
                        <View style={styles.sliderContainer}>
                            <Text style={styles.sliderLimitLeft}>0</Text>
                            <Slider
                                style={styles.slider}
                        ...
                        {/* Nút Chọn */}
                        <ButtonChoose text={t.host_time_button} onPress={handleChooseCustomTime} />
                    </View>
                </View>
            )}
            ...
            >
                {!showCustomTime ? (
                    <View style={styles.customTimeButton}>
                        <Text style={styles.customTimeText}>{t.host_more_time_control}</Text>
                        <ArrowDropdownIcon width={25} height={25} />
                    </View>
                ) : (
                    <View style={styles.customTimeButton}>
                        <Text style={styles.customTimeText}>{t.host_fewer_time_control}</Text>
