...
const HostScreen = ({ route, navigation }: Props) => {
    ...
    const [selectedTime, setSelectedTime] = useState<string>(route.params?.selectedTime ?? `${t.host_time_default} ${t.host_time_min}`);
    ...
    const handlePlay = () => {
        ...
        navigation.navigate('HostMatch', { accountLogin, friend, selectedTime, isRankingMode, selectedPiece }); // Tạo màn hình custom
    ...
    return (
        <ScrollView style={styles.scrollView} contentContainerStyle={{ alignItems: "center" }}>
            ...
            {/* Button Time Setting */}
            <ButtonHostTime icon={RapidTimeIcon} title={selectedTime} onPress={handleMoreTimeSetting} />
            ...
            <View style={styles.ranking_mode}>
                ...
                <ToggleButtonNotification value={isRankingMode} onToggle={handleRankingMode} />
            </View>
