export class GameState {
    constructor() {
        this.posArray = new Array(19);
        this.history1 = new Array(19);
        this.history2 = new Array(19);
        for (let i = 0; i < 19; i++) {
            this.posArray[i] = new Array(19).fill('0');
            this.history1[i] = new Array(19).fill('0');
            this.history2[i] = new Array(19).fill('0');
        }
    ...
    move(row, column, state) {
        ...
        let deathPosition = [];
        const currentGameState = new Array(19);
        for (let i = 0; i < 19; i++) {
            currentGameState[i] = new Array(19);
            for (let j = 0; j < 19; j++) {
        ...
        for (let i = 0; i < 19; i++) {
            isVisited[i] = new Array(19).fill(false);
        }
        ...
        if (this.canBreath(isVisited, row, column)) {
            ...
            for (let i = 0; i < a.length; i++) {
                ...
                if (this.posArray[childRow][childColmun] != '0' && this.posArray[childRow][childColmun] != this.posArray[row][column]) {
                    const isV = new Array(19);
                    for (let i = 0; i < 19; i++) {
                        isV[i] = new Array(19).fill(false);
                    }
