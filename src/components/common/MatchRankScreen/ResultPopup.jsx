  ...
  return (
    <View style={styles.container}>
      <View style={styles.popup}>
        <Text style={{...styles.result, color: isWin ? '#FFF400' : 'red'}}>
          {isWin ? t.win_text : t.lose_text}
        </Text>
        <Text style={styles.scoreText}>{getTextFromState()}</Text>
        <Text style={styles.scoreText}>
          {t.your_score_text}: {yourScore}
        </Text>

        <Text style={styles.scoreText}>
          {t.opponent_score_text}: {opponentScore}
        </Text>
        <TouchableOpacity
          style={styles.button}
          onPress={e => {
          ...
          <Text style={styles.buttonText}>Another match</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={e => {
